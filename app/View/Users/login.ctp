...
<div class="logo">
		...
		<?php 
echo $this->Html->link(
    $this->Html->image('/assets/admin/layout/img/logo-big.png'), '/', array('escape' => false)
);
		?>
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<div class="login-form users form">
 ...
 <?php echo $this->Form->input('username',array('class'=>'form-control placeholder-no-fix','placeholder'=>'Username','autocomplete'=>'off'));?>
			</div>
		</div>
		<div class="form-group">
			...
			<?php echo $this->Form->input('password',array('class'=>'form-control placeholder-no-fix','placeholder'=>'Password','autocomplete'=>'off'));?>
			</div>
		</div>
